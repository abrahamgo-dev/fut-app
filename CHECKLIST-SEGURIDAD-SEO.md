...
- [ ] Congelar cambios no urgentes y deploys paralelos.
- [ ] Confirmar que el fix de callbackUrl en login ya esta en produccion.
...
- [ ] AUTH_URL configurado a https://www.once-fc.com.
- [ ] Revisar NEXT_PUBLIC_PRELAUNCH_MODE segun estrategia actual.
- [ ] Revisar GOOGLE redirect URI de produccion.
...
- [ ] Enviar solicitud de revision en "Problemas de seguridad".
...
- [ ] 2026-**-** **:** Revision solicitada en Search Console
